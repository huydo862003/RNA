...
splice.js is a reactive computation library based on finite differencing.
...
See the [README](https://github.com/hdnax/rna/tree/main/packages/splice.js) for the full motivation and comparison with incremental computation and reactivity.
